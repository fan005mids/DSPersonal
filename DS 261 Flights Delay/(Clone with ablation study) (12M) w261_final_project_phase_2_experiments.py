...
# MAGIC %md
# MAGIC # [Archived] Some Simple Ablation Studies

# COMMAND ----------

# Baseline: Ablation without sample weights when training, no regularization
# Training: 0.182; Validation F1: 0.070
...
# MAGIC %md
# MAGIC Warning, run the below cell will change the transformed data!

# COMMAND ----------

# With data rebalance with sample weights, but no engineered features
# Training: 0.182; Validation F1: 0.070
